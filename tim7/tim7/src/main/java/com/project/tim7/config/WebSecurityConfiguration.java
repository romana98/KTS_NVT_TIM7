package com.project.tim7.config;

import com.project.tim7.security.TokenUtils;
import com.project.tim7.security.auth.RestAuthenticationEntryPoint;
import com.project.tim7.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/auth/login", "/auth/sign-up");
